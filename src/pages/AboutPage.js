          ...
          <FrostedContent>
            ...
            <Flex direction="column" gap="48px">
              <div>
                ...
                <Text>
                 At deHouse, our mission is to dismantle the traditional barriers to real estate ownership by democratizing access to real-world assets through collective co-ownership. We believe that transformative investment opportunities, property ownership, access to tax-advantaged locations, and income generating assets, shouldn't be reserved for the privileged few, but accessible to a global community of forward-thinking individuals instead. 
By leveraging blockchain technology we are building a self-sustaining treasury that pools collective resources together to acquire, monetize, and govern a diversified portfolio of properties worldwide. Our goal is to create a sustainable, and regenerative ecosystem where every member holds not just a stake in physical assets, but genuine governance rights, shared access to our community owned destinations, and participation in the yield generated by our growing treasury of assets. 
Simply put, DeHouse is pioneering a new model of community-owned RWA ownership where transparency, accessibility, and shared prosperity replace exclusivity and gatekeeping.
        ...
        <Container>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            ...
            <Text size="18px" style={{ maxWidth: '800px', margin: '0 auto' }}>
              Meet the passionate individuals behind deHouse who are dedicated to revolutionizing RWA co-ownership through blockchain technology.
            </Text>
          </div>
